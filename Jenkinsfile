pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/walshnj-lb-deploy/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('walshnj-225')   // <---- Change this to match your kubernetes cluster credentials
    }
